      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
          <TouchableOpacity style={[styles.Box, touch == 1 ? { borderColor: COLORS.primary } : null]} onPress={() => setTouch(1)}>
            <View style={{ flexDirection: 'row', marginBottom: 15, alignItems: 'center' }}>
              <Image style={{ height: 20, width: 20, marginRight: 10 }} source={require('assets/icons/png/ic_warehouse_color.png')} />
          ...
          <TouchableOpacity style={[styles.Box, touch == 2 ? { borderColor: COLORS.primary } : null]} onPress={() => setTouch(2)}>
            <View style={{ flexDirection: 'row', marginBottom: 15, alignItems: 'center' }}>
              <Image style={{ height: 20, width: 20, marginRight: 10 }} source={require('assets/icons/png/ic_boxes_color.png')} />
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 15 }}>
          <TouchableOpacity style={[styles.Box, touch == 3 ? { borderColor: COLORS.primary } : null]} onPress={() => setTouch(3)}>
            <View style={{ flexDirection: 'row', marginBottom: 15, alignItems: 'center' }}>
              <Image style={{ height: 24, width: 24, marginRight: 10 }} source={require('assets/icons/png/ic_shopping_cart.png')} />
          ...
          <TouchableOpacity style={[styles.Box, touch == 4 ? { borderColor: COLORS.primary } : null]} onPress={() => setTouch(4)}>
            <View style={{ flexDirection: 'row', marginBottom: 15, alignItems: 'center' }}>
              <Image style={{ height: 24, width: 24, marginRight: 10 }} source={require('assets/icons/png/ic_remove_from_cart.png')} />
        ...
        <View>
          <Text style={{ fontWeight: '600', fontSize: 17, marginTop: 20 }}>Tổng quan giá trị kho</Text>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginVertical: 10 }}>
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              <Text>{`1`}</Text>
              <Image style={{ height: 38, width: 38, marginRight: 10, marginHorizontal: 10 }} source={require('assets/icons/png/ic_remove_from_cart.png')} />
              <View style={{}}>
